...
<body>
			...
			<div  style=";margin:0 auto 0 auto" >
				...
				<div style = "float:right;position: relative;left:-50%;text-align: left;">
					<ul style = "position: relative;left:50%;margin-top:70px;margin-left: 150px">
						<li><a href ="#" style = "word-spacing: 10px;font-size: 20px">Начало</a></li>
						<li><a href="#" style = "word-spacing: 10px;font-size: 20px">Стаи</a></li>
						<li><a href="#" style = "word-spacing: 10px;font-size: 20px">Удобства</a></li>
						<li><a href="#" style = "word-spacing: 10px;font-size: 20px">Галерия</a></li>
	...
	<!--	<div style='width:100%; height:150%;background-image:url("images/hotel012ed.jpg")'>-->
			<?php
				...
				echo "<tr><td>Пристигане </td> <td><input type=\"text\" id=\"from_new\" value=\"$from\"></td></tr>";
				echo "<tr><td>Заминаване </td> <td><input type=\"text\" id=\"to_new\" value=\"$to\"></td></tr>";
