...
<html>
	...
	<title>Central Western Hotel</title>
	...
	<div id="page">
		<nav class="colorlib-nav" role="navigation">
			...
			<div  style=";margin:0 auto 0 auto" >
				<div "id="colorlib-logo" style ="float:left;width:250px;margin-bottom:20px;margin-left: 80px">
					<a href="indexBG.php"><img src = "./logo.png" style="width:100%;height:100%;margin-bottom: :20px auto 0 auto"></a>
				</div>
				<div style = "float:right;position: relative;left:-50%;text-align: left;">
					<ul style = "position: relative;left:50%;margin-top:70px;margin-left: 150px">
						<li><a href ="./indexBG.php" style = "word-spacing: 10px;font-size: 20px">Начало</a></li>
						<li><a href="./roomsBG.html" style = "word-spacing: 10px;font-size: 20px">Стаи</a></li>
						<li><a href="./aminitiesBG.html" style = "word-spacing: 10px;font-size: 20px">Удобства</a></li>
						<li><a href="./galleryBG.html" style = "word-spacing: 10px;font-size: 20px">Галерия</a></li>
		...
		<aside id="colorlib-hero">
			<div class="flexslider">
				<ul class="slides">
			   	<li style="background-image: url(images/hotel000.jpg);">
			   		<div class="overlay"></div>
			   		<div class="container-fluid">
			   			<div class="row">
				   			<div class="col-md-6 col-sm-12 col-md-offset-3 slider-text">
				   				<div class="slider-text-inner text-center">
				   					<h2>Добре дошли в Central Western Hotel</h2>
				   					<h1>Луксозен хотел</h1>
			   	...
			   	<li style="background-image: url(images/hotel018.jpg);">
			   		<div class="overlay"></div>
			   		<div class="container-fluid">
			   			<div class="row">
				   			<div class="col-md-6 col-sm-12 col-md-offset-3 slider-text">
				   				<div class="slider-text-inner text-center">
				   					<h2>Открий &amp; </h2>
				   					<h1>Everything you need in Central Western Hotel</h1>
										<!--<p><a class="btn btn-primary btn-demo" href="#"></i> View Detail</a> <a class="btn btn-primary btn-learn">Know More</a></p>-->
				   				</div>
				   			</div>
				   		</div>
			   	...
			   	<li style="background-image: url(images/hotel022.jpg);">
			   		<div class="overlay"></div>
			   	...
			   	<li style="background-image: url(images/hotel012.jpg);">
			   		<div class="overlay"></div>
			   		<div class="container-fluid">
			   			<div class="row">
				   			<div class="col-md-6 col-sm-12 col-md-offset-3 slider-text">
				   				<div class="slider-text-inner text-center">
				   					...
				   					<h1>In the heart of Central Western Hotel</h1>
										<!--<p><a class="btn btn-primary btn-demo" href="#"></i> View Detail</a> <a class="btn btn-primary btn-learn">Know More</a></p>-->
				   				</div>
				   			</div>
				   		</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-12 search-wrap">
						<form method="get" action = "./reservation.php" class="colorlib-form">
		              	<div class="row">
		                <div class="col-md-3">
		                  <div class="form-group">
		                    ...
		                    <div class="form-field">
		                      ...
		                      <input type="text" id="date" name="from" class="form-control date" placeholder="Пристигане">
		                    </div>
		                  </div>
		                </div>
		                <div class="col-md-3">
		                  <div class="form-group">
		                    ...
		                    <div class="form-field">
		                      <i class="icon icon-calendar2"></i>
		                      <input type="text" id="date" name ="to" class="form-control date" placeholder="Заминаване">
		                    </div>
		                  </div>
		                </div>
		                <div class="col-md-2">
		                  <div class="form-group">
		                    ...
		                    <div class="form-field">
		                      ...
		                      <select name="adults" id="people" class="form-control">
		                ...
		                <div class="col-md-2">
		                  <input type="submit" name="submit" id="submit" value="Изпрати" class="btn btn-primary btn-block">
		                </div>
		              </div>
		            </form>
					</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-3 animate-box text-center">
						<div class="services">
							<span class="icon">
								<img src="./room.png" height="80%" width="80%">
							</span>
							<h3>Големи стаи</h3>
					...
					<div class="col-md-3 animate-box text-center">
						<div class="services">
							<span class="icon">
								<img src="./conf.png" height="80%" width="80%">
							</span>
							<h3>Конферентна зала</h3>
							<p>Sample text Sample text Sample text Sample text Sample text Sample text Sample text Sample text Sample text Sample text Sample text Sample text Sample text </p>
						</div>
					</div>
					<div class="col-md-3 animate-box text-center">
						<div class="services">
							<span class="icon" >
								<img src="./location.png" height="80%" width="80%">
							</span>
							<h3>В центъра на София</h3>
							<p>Sample text Sample text Sample text Sample text Sample text Sample text Sample text Sample text Sample text Sample text Sample text Sample text Sample text </p>
						</div>
					</div>
					<div class="col-md-3 animate-box text-center">
						<div class="services">
							<span class="icon">
								<img src="./cafe.png" height="80%" width="80%">
							</span>
							<h3>Лоби бар</h3>
							<p>SSample text Sample text Sample text Sample text Sample text Sample text Sample text Sample text Sample text Sample text Sample text Sample text Sample text </p>
						</div>
					</div>
				</div>
			</div>
		...
		<div id="colorlib-rooms" class="colorlib-light-grey">
				...
				<div class="row">
					<div class="col-md-12 animate-box">
						<div class="owl-carousel owl-carousel2">
							<div class="item">
								<a href="images/room-1.jpg" class="room image-popup-link" style="background-image: url(images/hotel001.jpg);"></a>
							...
							<div class="item">
								<a href="images/room-2.jpg" class="room image-popup-link" style="background-image: url(images/hotel007.jpg);"></a>
								<div class="desc text-center">
							...
							<div class="item">
								<a href="images/room-3.jpg" class="room image-popup-link" style="background-image: url(images/hotel008.jpg);"></a>
								<div class="desc text-center">
									<span class="rate-star"><i class="icon-star-full full"></i><i class="icon-star-full full"></i><i class="icon-star-full full"></i><i class="icon-star-full full"></i><i class="icon-star-full"></i></span>
			...
			<div id="map" style="width:60%;height:600px;margin:0 auto 0 auto"></div>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></small>
	...
	<script>
		function myMap() {
  			var myCenter = new google.maps.LatLng(42.701389,23.302139);
